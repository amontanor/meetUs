...
public class PushReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		try {
			...
			if (accion.equals("com.example.meetus.UPDATE_STATUS")) {
			...
			} else if (accion.equals("com.example.meetus.PREGUNTA_ESTADO")) {
				String id = json.getString("id");
				Herramientas.mandarRespuestaDeEstadoActual(id);
			} else if (accion.equals("com.example.meetus.RESPUESTA_ESTADO")) {
				String id = json.getString("id");
				Herramientas.RecibirRespuestaDeEstadoActual(id, "online");
			} else if (accion.equals("com.example.meetus.DESCONECTADO")) {
				String id = json.getString("id");
				Herramientas.RecibirRespuestaDeEstadoActual(id, "offline");
			} else if (accion.equals("com.example.meetus.ACEPTA")) {
				String id = json.getString("id");
